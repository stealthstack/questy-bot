...
- [x] Create `create_expedition_results_embed(results, ctx)` helper
...
- [ ] Refactor `submit_results` command to use `create_expedition_results_embed`
- [ ] Refactor `ExpeditionView.check_results` to use `create_expedition_results_embed`
